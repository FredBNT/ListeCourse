...
<body class="container">
	...
	<div class="col-12">
		...
		<h2 class="my-5 text-center">
			Votre panier <small>${listeCourse.nom}</small>
		</h2>
								...
								<div>
									<form action="${pageContext.request.contextPath}/panier"
										...
										<label class="custom-control custom-checkbox"> 
											...
											onclick="document.forms['form${a.id}'].submit();"
											${a.coche?"checked":""} /> 
	...
	<footer class="row bg-dark footer-demodule fixed-bottom py-1">
		...
		<div class="text-center col-2 offset-2">
			<a class="btn"
				href="${pageContext.request.contextPath}/panier?id=${listeCourse.id}&clear"
				title="clear"><i class="material-icons">clear</i></a>
		</div>
	</footer>
